...
<body>
	<button type="submit" style="background-color: maroon; font-weight: 900;"><a href="../p7.php" style=" color: white; text-decoration: none;">KEMBALI KE HALAMAN PERTEMUAN 7</a></button>
	<div class="in">
