			...
			<div class="container">
				<div class="nav-wrapper">
					...
					<ul id="nav-mobile" class="right hide-on-med-and-down">
						<li style="border: 1px solid black; background-color: maroon;color: black;"><a href="php/login.php">LOGIN ADMIN</a></li>
						<li style="border: 1px solid black; background-color: maroon;color: black;"><a href="../../index.php">HOME</a></li>
					</ul>
