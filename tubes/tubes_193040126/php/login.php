...
<body>
  <div class="container">
    <form action="" method="POST">
      <?php if (isset($error)) : ?>
        <p style="color: white; font-style: italic;">Username atau password salah!</p>
      <?php endif; ?>
      ...
      <div class="login">
        <button type="submit" name="submit" style="font-weight: 900; color: maroon;">LOG IN</button>
      </div>

      <div class="registrasi">
        <p>Belum punya akun? Registrasi <a href="registrasi.php" style="color: black; font-weight: 900; text-decoration: none;">Disini</a></p>
      </div>
